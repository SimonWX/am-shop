<template>
  <div class="container">
      ...
      <swiper class="hot-goods-swiper" :options="swiperOption">
        <swiper-slide v-for="(item, index) in goodList" :key="index">
          <div class="hot-goods-swiper-content">
            <img :src="item.imgHot" alt />
            <div>{{item.nameHot}}</div>
    ...
    <div class="variety">
      <p>推荐商品</p>
      <ul>
        <li class="variety-item" v-for="(item, index) in goodList" :key="index">
          <img :src="item.imgVariety" />
...
export default {
  ...
  created() {
    // let url = "https://bird.ioliu.cn/v2?url=https://api.douban.com/v2/movie/top250";
